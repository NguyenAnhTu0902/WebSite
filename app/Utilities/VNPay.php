...
class  VNPay
{
     ...
     *
     */
    static $vnp_TmnCode = "F7HCV82H"; //Mã website tại VNPAY
    static $vnp_HashSecret = "VBQPTGOMRLTICZPLZREPBUAFJCSHRQZO"; //Chuỗi bí mật
    static $vnp_Url = "http://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
    static $vnp_Returnurl = "/order/vnPayCheck"; //Chú ý cấu hình env('APP_URL') khi sử dụng biến này.
