        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <form method="post" action="admin/products/{{$product->id}}/details/{{$productDetail->id}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="position-relative row form-group mb-1">
                                <div class="col-md-9 col-xl-8 offset-md-2">
                                    <a href="admin/products/{{$product->id}}/details" class="border-0 btn btn-outline-danger mr-1">
