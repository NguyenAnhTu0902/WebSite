                    ...
                    <ul class="vertical-nav-menu">
                        ...
                        <li class="mm-active">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="/admin/orders" class="{{ (request()->segment(2) == 'orders') ? 'mm-active' : ''}}">
                                        <i class="metismenu-icon"></i>Order
                                    </a>
                                </li>
                                <li>
                                    <a href="/admin/products" class="{{ (request()->segment(2) == 'products') ? 'mm-active' : ''}}">
                                ...
                                <li>
                                    <a href="/admin/brands" class="{{ (request()->segment(2) == 'brands') ? 'mm-active' : ''}}">
